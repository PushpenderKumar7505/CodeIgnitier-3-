													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
															<div class="menu-item px-3">
																<a href="<?php echo base_url("Userview")?>" class="menu-link px-3">Edit</a>
															</div>
															<div class="menu-item px-3">
																<a href="<?php echo base_url("deleteUserData/") . $user["user_id"]; ?>" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Delete</a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
