									...
									<div class="card mb-5 mb-xl-10">
										<div class="card-body pt-9 pb-0">
											...
											<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
												...
												<li class="nav-item mt-2">
													<a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="<?=base_url('Logs/').$id?>">Logs</a>
												</li>
												<!--end::Nav item-->
												<!--begin::Nav item-->
												<!-- <li class="nav-item mt-2">
											...
											<table class="table align-middle table-row-dashed gy-5 dataTable no-footer" id="kt_table_customers_payment">
												<thead class="border-bottom border-gray-200 fs-7 fw-bold">
													<tr class="text-start text-muted text-uppercase gs-0">
														<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_table_customers_payment" rowspan="1" colspan="1" aria-label="Invoice No.: activate to sort column ascending" style="width: 30px;">Phone</th>
														<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_table_customers_payment" rowspan="1" colspan="1" aria-label="Invoice No.: activate to sort column ascending" style="width: 50px;">Date</th>
														<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_table_customers_payment" rowspan="1" colspan="1" aria-label="Date: activate to sort column ascending" style="width: 100px;">Api Name</th>
			
														<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_table_customers_payment" rowspan="1" colspan="1" aria-label="Invoice No.: activate to sort column ascending" style="width: 78px;">Address </th>
														<th class="min-w-100px sorting" tabindex="0" aria-controls="kt_table_customers_payment" rowspan="1" colspan="1" aria-label="Invoice No.: activate to sort column ascending" style="width: 78px;">status </th>
...
foreach($login as $record){
	
	?>
													<tr class="odd">
														<td>
															<a href="#" class="text-gray-600 text-hover-primary mb-1"><?=$record['phone']?></a>
														</td>
														<td>
															<a href="#" class="text-gray-600 text-hover-primary mb-1"><?=$record['create_dt']?></a>
														</td>
														<td data-order="2020-12-14T20:43:00+05:30"><?=$record['api_name']?></td>
														<td>
															<span class="badge badge-light-success"><?=$record['ip_address']?></span>
														</td>
														<td>
															<span class="badge badge-light-success"><?php if($record['status']==1){
																echo "Success";}?></span>
														</td>
