<div id="kt_app_footer" class="app-footer">
							...
							<div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
								...
								<div class="text-gray-900 order-2 order-md-1">
									...
									<a href="https://www.mentobile.com/" target="_blank" class="text-gray-800 text-hover-primary">Mentobile</a>
								</div>
								<!--end::Copyright-->
							</div>
...
<!-- common for all customer_list, hostess_view, agent -->
<script>
		var hostUrl = "assets/";
	</script>
